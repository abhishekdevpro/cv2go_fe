...
//     { name: 'Blue', class: 'bg-orange-500', selectedClass: 'ring-blue-400', hexCode: '#2563EB' },
//     { name: 'Purple', class: 'bg-purple-600', selectedClass: 'ring-purple-400', hexCode: '#9333EA' },
//     { name: 'Green', class: 'bg-orange-600', selectedClass: 'ring-orange-400', hexCode: '#16A34A' },
...
//                       className="w-5 h-5 text-orange-500 border-gray-300 focus:ring-blue-500"
//                     />
                ...
                {["With Photo", "Without Photo"].map((option) => (
                  ...
                  >
                    <input
                      ...
                      className="w-5 h-5 text-cyan-600 border-gray-300 focus:ring-blue-500"
                    />
