...
//           ${isDragActive ? 'border-orange-400 bg-blue-50' : 'border-gray-300 hover:border-orange-400'}
...
//             </p>
//             <button className="px-6 py-3 bg-orange-500 text-white rounded-lg hover:bg-cyan-600 transition-colors">
//               Select PDF File
//             </button>
...
//           className="px-8 py-3 bg-orange-500 text-black rounded-lg font-medium hover:bg-orange-600 transition-colors
