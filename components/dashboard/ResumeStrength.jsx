...
//             <button className="mt-2 px-6 py-2 bg-cyan-600 text-white rounded-lg hover:bg-cyan-600">
//               Improve Resume
//             </button>
//           </div>
//         </div>
...
//               <div className={`p-1 rounded-full ${section.completed ? 'bg-orange-100 text-orange-600' : 'bg-red-100 text-red-600'}`}>
//                 {section.completed ? (
        ...
        <div className="flex justify-between items-start mb-4">
          ...
          <div className="flex flex-col items-end">
            ...
            <button
              ...
              disabled={!resumeId}
              className={`mt-2 px-6 py-2 bg-cyan-600 text-white rounded-lg hover:bg-cyan-600 w-full sm:w-auto ${
