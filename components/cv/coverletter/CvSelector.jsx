...
const TemplateSelector = ({ selectedTemplate, setSelectedTemplate }) => {
  ...
  return (
    <div className="font-sans">
      ...
      <button
        onClick={openModal}
        className="block md:hidden rounded-lg border-2 m-2 border-orange-500 px-5 py-2 font-bold bg-white text-orange-500"
      >
        Template
      </button>
                  ...
                  {getDisplayedTemplates().map((template) => (
                    ...
                    >
                      <div
                        ...
                        ${
                          template.key === templateId
                            ? "bg-blue-100 ring-4 ring-cyan-500 ring-offset-2"
                            : "hover:bg-gray-50"
                        }
                      `}
                      >
