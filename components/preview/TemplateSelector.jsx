...
//       <button
//         onClick={openModal}
//         className="rounded-lg border-2 m-2 border-cyan-800 px-5 py-2 font-bold bg-white text-cyan-800 "
//       >
//         Select Template
//       </button>
...
const TemplateSelector = ({ selectedTemplate, setSelectedTemplate }) => {
  ...
  return (
    <div className="font-sans">
      <button
        onClick={openModal}
        className="hidden md:block rounded-lg border-2 m-2 border-orange-500 px-5 py-2 font-bold bg-white text-black"
      >
        <span>Selected: {templateId || "template1"}</span>
      </button>
      <button
        onClick={openModal}
        className="block md:hidden rounded-lg border-2 m-2 border-orange-500 px-5 py-2 font-bold bg-white text-black"
      >
        Template
      </button>
                  ...
                  {getDisplayedTemplates().map((template) => (
                    ...
                    >
                      <div
                        ...
                        ${
                          template.key === templateId
                            ? "bg-cyan-100 ring-4 ring-cyan-500 ring-offset-2"
                            : "hover:bg-gray-50"
                        }
                      `}
                      >
                            ...
                            className={`
                              ...
                              ${
                                template.key === templateId
                                  ...
                                  : "group-hover:ring-2 group-hover:ring-cyan-300"
                              }
                            `}
                          />
                          {template.key === templateId && (
