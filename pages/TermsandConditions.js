...
//           <li>
//             Client: Any individual or entity using the services of CV2GO.
//           </li>
//           <li>Company: CV2GO.</li>
//           <li>
...
//         <ul className="list-inside list-disc pl-4 text-base sm:text-lg">
//           <li>
//             All content, materials, and services provided by CV2GO are
...
//         <ul className="list-inside list-disc pl-4 text-base sm:text-lg">
//           <li>
//             CV2GO will not be liable for any direct, indirect, incidental,
