...
//               </h3>
//               <button
//                 className="p-2 bg-cyan-600 rounded-md text-white hover:bg-cyan-600 mt-4"
//                 onClick={handleBack}
//               >
//                 Back
//               </button>
...
//                 <button
//                   className="p-2 bg-cyan-600 rounded-md text-white hover:bg-cyan-800"
      ...
      <div className="flex-1 py-24 bg-slate-200 px-5">
        {showResults ? (
          ...
          <>
            ...
            <div className="flex justify-between">
              <button
                className="p-2 bg-cyan-600 rounded-md text-white"
                onClick={handlePrevious}
                disabled={currentQuestionIndex === 0}
              >
