...
// //             <h1 className="font-bold text-xl mb-4">CV2GO  Builder</h1>
// //             <div className="flex items-center gap-2 font-medium mb-2">
// //               <i className="fa-solid fa-check border-2 px-2 py-2 rounded-full text-white bg-cyan-500"></i>
// //               <span>AI Score</span>
// //             </div>
// //             <div className="flex items-center gap-2 font-medium mb-2">
// //               <i className="fa-solid fa-check border-2 px-2 py-2 rounded-full text-white bg-cyan-500"></i>
...
// //               <button className="px-6 py-3 rounded-2xl font-semibold text-black bg-cyan-500 hover:bg-cyan-500 shadow-md">
...
//               <h2 className="mb-4 text-4xl tracking-tight font-extrabold  rounded-2xl text-cyan-600 border p-3 border-gray">
...
//                     {/* Icon */}
//                     <svg
//                       className="flex-shrink-0 w-5 h-5 text-cyan-500 dark:text-cyan-500"
//                       fill="currentColor"
//                       viewBox="0 0 20 20"
        ...
        <section className=" ">
          <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            ...
            <div className="text-center">
              <button
                className="rounded-full px-8 py-3 text-lg font-medium text-white bg-cyan-600 rounded-xl hover:bg-cyan-800 transition duration-300 "
