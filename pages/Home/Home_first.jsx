...
//                         <button className='  px-6 py-2 text-lg text-white bg-cyan-600 rounded-full font-bold hover:shadow-2xl hover:shadow-slate-500'
...
//                     }
//                   >
//                     <button className=" text-white bg-orange-500 text-lg px-6 py-2 rounded-full  font-bold hover:shadow-2xl hover:shadow-slate-500 ">
//                       {" "}
//                       Build your Resume
//                     </button>
//                   </Link>
